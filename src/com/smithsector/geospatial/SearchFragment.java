...
//		_foundPlacesAdapter = new FoundPlacesArrayAdapter(_contextReference,
//				R.layout.place_listitem, new ArrayList<Place>());
//		_foundPlacesListView = (ListView) findViewById(R.id.foundPlacesListView);
...
//				PlaceDatasource.initializedInstance(_contextReference).addItem(
//						place);
//
//				finish();
//			}
